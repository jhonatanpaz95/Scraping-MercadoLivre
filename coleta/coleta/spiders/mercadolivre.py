    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            item = {
                ...
                'name': product.css('h2.ui-search-item__title.ui-search-item__group__element a::text').get(),
            ...
            print(f"Scraped item: {item}")  # Para checar os itens coletados no terminal
            yield item
