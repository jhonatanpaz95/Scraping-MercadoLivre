...
col2.metric(abel='Numero de Marcas Únicas', value=unique_brands)

# KPI 3: numero total de itens
average_new_price = df['new_price'].mean()
col3.metric(abel='Preço Médio Novo (R$)', value=f'{average_new_price:.2f}')
...
satisfaction_by_brand = df_non_zero_reviews.groupby('brand')['reviews_rating_number'].sort_values(ascending=False)
